...
public interface PostMapper {
     ...
     * @return 帖子
     */
    List<FsPost> getSelect_Name_Posts(@Param("details") String details,@Param("page")int page,@Param("limit")int limit);
     ...
     * @return 数量
     */
    int getSelect_Posts_Count(@Param("details") String details);
